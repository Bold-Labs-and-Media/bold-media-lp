...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-tablist text-tablist-foreground inline-flex w-fit items-center justify-center rounded-sm",
        className
      )}
      {...props}
    />
